...
c;return"stop"!==(c=$(e).triggerHandler("jqGridPaging",[a,b]))&&($.isFunction(e.p.onPaging)&&(c=e.p.onPaging.call(e,a,b)),"stop"!==c&&(e.p.selrow=null,e.p.multiselect&&(e.p.selarrrow=[],W(!1)),e.p.savedRow=[],!0))};if(a=a.substr(1),b+="_"+a,c="pg_"+a,d=a+"_left",f=a+"_center",g=a+"_right",$("#"+$.jgrid.jqID(a)).append("<div id='"+c+"' class='ui-pager-control' role='group'><table "+l(m,"pagerTable",!1,"ui-pg-table ui-common-table ui-pager-table")+"><tbody><tr><td id='"+d+"' align='left'></td><td id='"+f+"' align='center' style='white-space:pre;'></td><td id='"+g+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr"),e.p.rowList.length>0){t='<td style="padding-left:10px;">显示条数：</td><td dir="'+i+'">',t+="<select "+l(m,"pgSelectBox",!1,"ui-pg-selbox")+' role="listbox" title="'+($.jgrid.getRegional(e,"defaults.pgrecs",e.p.pgrecs)||"")+'">';var
